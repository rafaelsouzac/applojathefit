...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-br" lang="pt-br">
    <head>
        ...
        <link href="incluir/css/base_pagina.css" rel="stylesheet" type="text/css" />
        <link href="incluir/css/cadastro-fornecedor-produto.css" rel="stylesheet" type="text/css" />
    </head>
    <body>
        <!-- PARTE SUPERIOR -->
            <?php require_once './visual/parte-superior-fornecedor-produto.php'; ?>
            <hr>

        <!-- SCROLL DOS PRODUTOS DAS VENDAS -->        
            <?php require_once './visual/centro-fornecedor-produto.php'; ?>
        
        <!-- PARTE FIXA FECHAMENTO PEDIDO -->
            <?php require_once './visual/parte-inferior-fornecedor-produto.php'; ?>
    </body>
</html>